...
import { useReturnsEdge } from './useReturnsEdge'
import type { ReturnsEdgeProps } from './types'
...
const ReturnsEdge = ({
  ...
  targetPosition,
  selected,
}: ReturnsEdgeProps): React.JSX.Element => {
  const { isHovered, setIsHovered, handleDelete } = useReturnsEdge(id)
  ...
  const markerEnd = 'url(#returns-arrow)'
