...
import { useAcceptsEdge } from './useAcceptsEdge'
import type { AcceptsEdgeProps } from './types'
...
const AcceptsEdge = ({
  ...
  targetPosition,
  selected,
}: AcceptsEdgeProps): React.JSX.Element => {
  const { isHovered, setIsHovered, handleDelete } = useAcceptsEdge(id)
  ...
  const markerEnd = 'url(#accepts-arrow)'
